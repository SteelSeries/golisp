...
func RegisterFramePrimitives() {
	...
	MakeTypedPrimitiveFunction("lisp->json", "1", LispToJsonImpl, []uint32{NilType | FrameType | ConsCellType | VectorType | BoxedObjectType | IntegerType | FloatType | StringType | SymbolType | BooleanType})
