...
func RegisterBytearrayPrimitives() {
	...
	MakeTypedPrimitiveFunction("bytearray-copy", "1", BytearrayCopyImpl, []uint32{BoxedObjectType})
...
func BytearrayCopyImpl(args *Data, env *SymbolTableFrame) (result *Data, err error) {
